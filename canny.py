'''
Uses skimage.feature.canny() to create binary image, on which skimage.hough_line()
and skimage.hough_line_peaks() is run. This code takes two images: a calibration
image and a second image, and attempts jet detection on both of them. Only the
strongest line found by the Hough transform is displayed.
'''
